...
public class SwaggerConfig {
    ...
    public Docket restApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("标准接口")
                .apiInfo(apiInfo("ClassmateGalaxy软件接口", "1.0"))
                .useDefaultResponseMessages(true)
                .forCodeGeneration(false)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.se.classmategalaxy.controller"))
     ...
     * 访问地址：http://localhost:5565/swagger-ui/index.html
     *
     * @return
     */
